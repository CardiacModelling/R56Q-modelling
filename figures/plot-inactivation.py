...
for c in cs:
    ...
    if args.show == True:
        ...
        filename = 'Inactivation-' + mutant_str + '-model-' + model_str + '-fit-' + protocol_str + '-cell-' + str(cell)
...
if args.show == True:
    ...
    filename = 'Inactivation-SS-biomarker-' + mutant_str + '-model-' + model_str + '-fit-' + protocol_str
    pl.savefig('PNG_figures/' + filename + '.png')
